            ...
            {round.categories.map((category) => (
              ...
              >
                <div className="min-h-[6.5rem] flex items-center justify-center">
                  <span className="category-text uppercase leading-tight">
                    {category.name}
                  </span>
                </div>
              </th>
          ...
          {values.map((value, rowIndex) => (
            <tr key={rowIndex}>
              {round.categories.map((category) => {
                ...
                const isSelected =
                  gameState.selectedClue?.categoryId === category.id &&
                ...
                const isVisible =
                  visibleClues === undefined || visibleClues.has(clueKey);
                ...
                return (
                  <td
                    ...
                    onClick={() =>
                      ...
                      clue &&
                      !isRevealed &&
                      handleClueClick(category.id, clue.id)
                    }
                  >
