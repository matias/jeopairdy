...
- **600 (Medium):** Requires a specific fact that is _not_ common knowledge. A trivia enthusiast would likely know, but a casual observer would be guessing.
...
- **Clue/Answer Format:**
  - The "clue" field is the _answer_ (what contestants see).
  - The "answer" field is the _question_ (what contestants must respond with, e.g., "What is...", "Who is...").
...
- All 30 clues (6 categories x 5 clues) MUST be _about_ one of the topics provided by the user.
